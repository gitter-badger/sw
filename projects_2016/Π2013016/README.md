...
Στη νέα υλοποίηση παρατηρήθηκε ένα πρόβλημα με τον χρόνο φόρτωσης της σελίδας.
Το πρόβλημα εντοπίστηκε με την χρήση ενός ειδικού plugin P3 (Plugin Performance Profiler) και προερχόταν από ένα απο τα plugins που χρησιμοποιούσε απο default
το θέμα και δεν το χρειαζόμασταν (rtmedia)
Το προβληματικό plugin απενεργοποιήθηκε χωρίς να επιρρεάζει την λειτουργία της σελίδας.
Επιπλέον προστέθηκε το W3 total cache για βελτιωθεί ακόμα περισσότερο η ταχύτητα φόρτωσης της σελίδας.
Πλέον το avg load time είναι λιγότερο απο 3 sec όπου για ένα δίγλωσσο CMS είναι normal, δεν είναι γρήγορο αλλά είναι φυσιολογικό.
Το di.ionio.gr στην παλαιά υλοποίηση του joomla οπως έχει μεγαλύτερο load time.
